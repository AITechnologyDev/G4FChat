...
1. **Улучшенный интерфейс**:
   - Добавлены ограничения ширины для всех панелей
   - Улучшено форматирование вывода команд
   - Кликабельные ссылки на сохранённые файлы
   - Более информативные сообщения о сохранении кода

2. **Оптимизации кода**:
   - Улучшена обработка ошибок при сохранении файлов
   - Оптимизированы регулярные выражения для извлечения кода
   - Улучшена потокобезопасность операций с файлами

3. **Документация**:
   - Обновлён README с описанием новых функций
   - Добавлены секции "New in 1.1.0"
   - Улучшены таблицы команд для обеих языковых версий
   - Добавлены ссылки на файловую структуру

4. **Мелкие улучшения**:
   - Добавлен перевод для сообщения о сохранении кода
   - Улучшено форматирование статистики
   - Оптимизированы тексты помощи
   - Добавлены новые ключи перевода

5. **Версионирование**:
   - Обновлена версия проекта до 1.1.0
   - Добавлены соответствующие бейджи в README
   - Упоминание новых функций в описании
